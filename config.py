...
from event_taxonomy import RETIRED_FIXED_WINDOW_EVENTS, TIER_A_EVENTS, TIER_B_EVENTS
...
# Default live allowlist keeps primary tactical events enabled. Research,
# blocking, unknown, and retired names are still rejected downstream.
DEFAULT_TRADE_EVENTS = ",".join(sorted(TIER_A_EVENTS | TIER_B_EVENTS))

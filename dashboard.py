...
const EVT_COLOR = {
  THRONE_EXPOSED:             '#f97316',
  BASE_PRESSURE_T4:           '#fb923c',
  BASE_PRESSURE_T3_COLLAPSE:  '#c084fc',
  OBJECTIVE_CONVERSION_T4:    '#f59e0b',
  OBJECTIVE_CONVERSION_T3:    '#a78bfa',
  OBJECTIVE_CONVERSION_T2:    '#c9952a',
  POLL_ULTRA_LATE_FIGHT_FLIP: '#dc2626',
  POLL_LATE_FIGHT_FLIP:       '#ef4444',
  POLL_STOMP_THROW_CONFIRMED: '#d946ef',
  POLL_LEAD_FLIP_WITH_KILLS:  '#fb7185',
  POLL_MAJOR_COMEBACK_RECOVERY:'#f43f5e',
  POLL_COMEBACK_RECOVERY:     '#fda4af',
  POLL_KILL_BURST_CONFIRMED:  '#a3e635',
  POLL_FIGHT_SWING:           '#93c5fd',
  BLOODY_EVEN_FIGHT:          '#cbd5e1',
};
const EVT_SHORT = {
  THRONE_EXPOSED:             'THRONE',
  BASE_PRESSURE_T4:           'BASE T4',
  BASE_PRESSURE_T3_COLLAPSE:  'BASE T3',
  OBJECTIVE_CONVERSION_T4:    'OBJ T4',
  OBJECTIVE_CONVERSION_T3:    'OBJ T3',
  OBJECTIVE_CONVERSION_T2:    'OBJ T2',
  POLL_ULTRA_LATE_FIGHT_FLIP: 'ULTRA FLIP',
  POLL_LATE_FIGHT_FLIP:       'LATE FIGHT',
  POLL_STOMP_THROW_CONFIRMED: 'THROW',
  POLL_LEAD_FLIP_WITH_KILLS:  'LEAD FLIP',
  POLL_MAJOR_COMEBACK_RECOVERY:'MAJOR REC',
  POLL_COMEBACK_RECOVERY:     'RECOVERY',
  POLL_KILL_BURST_CONFIRMED:  'KILL BURST',
  POLL_FIGHT_SWING:           'FIGHT',
  BLOODY_EVEN_FIGHT:          'EVEN FIGHT',
};
function evtTag(t) {
  if (!t) return '';
